  ...
  (package
    ...
    (arguments
     (list
      ...
      #:phases #~(modify-phases %standard-phases
                   (delete 'build))))
    (inputs (list node-readable-stream ;-1.1.14
 node-streamsearch ;-0.1.2
))
     ...
     (list
      ...
      #:phases #~(modify-phases %standard-phases
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("tap")))))))
    (inputs (list node-inherits ;-2.0.4
 node-string-decoder ;-0.10.31
...
(define-public node-babel-plugin-syntax-export-namespace-from
  (package
    ...
    (inputs (list node-babel-helper-plugin-utils ;-7.24.0
...
(define-public node-update-browserslist-db
  (package
    ...
    (inputs (list node-picocolors ;-1.0.0
 node-escalade ;-3.1.2
                  ;; DEBUG I had to comment this line to avoid dependency cycle issue.
  ...
  (package
    ...
    (arguments
     (list
      ...
      #:phases #~(modify-phases %standard-phases
                   (delete 'build))))
    (inputs (list node-update-browserslist-db ;-1.0.13
 node-node-releases ;-2.0.14
...
(define-public node-babel-generator
  (package
    ...
    (inputs (list node-jsesc ;-2.5.2
 node-jridgewell-trace-mapping ;-0.3.25
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("ava" "coveralls"
                                              ...
                                              "typescript"
                                              "xo")))))))
    (inputs (list node-supports-color ;-5.5.0
...
(define-public node-babel-core
  (package
    ...
    (inputs (list node-semver ;-6.3.1
		  ...
		  ;; DEBUG I had to modify the version because it contains a string 'beta' after the last '-' and part of the version was not well treated by my replacement script.
...
(define-public node-babel-helper-module-transforms
  (package
    ...
    (inputs (list node-babel-helper-validator-identifier ;-7.22.20
                  ...
                  node-babel-helper-environment-visitor ;-7.22.20
		  ;; DEBUG I had to comment this dependency because anyway it was remoed from the modify-phases above and if it was kept, it would cause a dependency cycle issue.
                  ;;node-babel-core ;-7.24.4
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@commitlint/cli"
                                              ...
                                              "testdata-w3c-json-form"
                                              "xo")))))))
    (inputs (list node-fix-esm ;-1.0.1
 node-multer ;-1.4.4
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@types/node" "c8" "mocha"
                                              "node-gyp" "prettier"
                                              "typescript")))))))
    (inputs (list node-node-addon-api ;-7.1.0
 node-phc-format ;-1.0.0
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("airtap" "benchmark"
                                              ...
                                              "through2"
                                              "uglify-js")))))))
    (inputs (list node-ieee754 ;-1.2.1
...
(define-public node-restore-cursor
  (package
    ...
    (inputs (list node-signal-exit ;-3.0.7
 node-onetime ;-5.1.2
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("ava" "coveralls"
                                              ...
                                              "tsd"
                                              "xo")))))))
    (inputs (list node-supports-color ;-7.2.0
...
(define-public node-log-symbols
  (package
    ...
    (inputs (list node-is-unicode-supported ;-0.1.0
 node-chalk ;-4.1.2
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("ava" "chalk" "coveralls"
                                              "has-ansi" "nyc" "xo")))))))
    (inputs (list node-strip-ansi ;-6.0.1
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@ungap/url-search-params"
                                              ...
                                              "teeny-request"
                                              "encoding")))))))
    (inputs (list node-whatwg-url ;-5.0.0
...
(define-public node-npmlog
  (package
    ...
    (inputs (list node-set-blocking ;-2.0.0
 node-gauge ;-3.0.2
     ...
     (list
      ...
      #:phases #~(modify-phases %standard-phases
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("matcha" "tape")))))))
    (inputs (list node-concat-map ;-0.0.1
...
(define-public node-simple-get
  (package
    ...
    (inputs (list node-simple-concat ;-1.0.1
 node-once ;-1.4.0
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@types/node" "assert-rejects"
                                              ...
                                              "standard"
                                              "typescript")))))))
    (inputs (list node-simple-get ;-3.1.1
 node-nan ;-2.19.0
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@domenic/eslint-config" "c8"
                                              "eslint")))))))
    (inputs (list node-whatwg-url ;-14.0.0
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@types/node" "browserify"
                                              ...
                                              "tape"
                                              "typescript")))))))
    (inputs (list node-mime-types ;-2.1.35
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;; BEGINNING OF ADDED DEFINITION ;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;; DEBUG : I had to add typescript for the build of 'node-entities' below.
;; As it is required as input during build.
  ...
  (package
   ...
   (source
    (origin
     ...
     (sha256
      (base32 "0j2c8m1w77dcz4bfmnzwsfjc2f9wpf5pfcblg7pnx4smy203nnqa"))))
   (build-system node-build-system)
   (arguments
    (list
     #:tests? #f
     #:phases #~(modify-phases %standard-phases
			       ...
			       (add-after 'patch-dependencies 'delete-dev-dependencies
					  (lambda _
					    (delete-dependencies '("@esfx/canceltoken"
								   "@octokit/rest"
								   "@types/chai"
								   "@types/glob"
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("assume" "browserify"
                                              ...
                                              "sauce-test"
                                              "uglify-js")))))))
    (inputs (list node-requires-port ;-1.0.0
 node-querystringify ;-2.2.0
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("async" "eslint"
                                              ...
                                              "prettier"
                                              "vows")))))))
    (inputs (list node-url-parse ;-1.5.10
 node-universalify ;-0.2.0
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@domenic/eslint-config"
                                              ...
                                              "eslint"
                                              "webidl2js")))))))
    (inputs (list node-webidl-conversions ;-7.0.0
 node-tr46 ;-5.0.0
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("benchmark" "browserify"
                                              ...
                                              "tmp"
                                              "typescript")))))))
    (inputs (list node-setimmediate ;-1.0.5
 node-readable-stream ;-2.3.8
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("deep-equal" "eslint"
                                              ...
                                              "mocha"
                                              "nyc")))))))
    (inputs (list node-negotiator ;-0.6.3
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("eslint" "express" "mocha" "nyc"
                                              "restify" "supertest")))))))
    (inputs (list node-keygrip ;-1.1.0
 node-depd ;-2.0.0
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("eslint"
                                              ...
                                              "istanbul"
                                              "mocha")))))))
    (inputs (list node-http-errors ;-1.8.1
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("koa" "koa-v1"
                                              ...
                                              "standard"
                                              "supertest")))))))
    (inputs (list node-koa-compose ;-4.2.0
 node-co ;-4.6.0
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@ljharb/eslint-config" "aud"
                                              ...
                                              "safe-publish-latest"
                                              "tape")))))))
    (inputs (list node-set-function-length ;-1.2.2
 node-get-intrinsic ;-1.2.4
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@ljharb/eslint-config" "aud"
                                              ...
                                              "safe-publish-latest"
                                              "tape")))))))
    (inputs (list node-hasown ;-2.0.2
 node-has-symbols ;-1.0.3

                  node-has-proto ;-1.0.3
 node-function-bind ;-1.1.2
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("@ljharb/eslint-config"
                                              ...
                                              "tape"
                                              "typescript")))))))
    (inputs (list node-object-inspect ;-1.13.1
 node-get-intrinsic ;-1.2.4

                  node-es-errors ;-1.3.0
 node-call-bind ;-1.0.7
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("autod" "egg-bin"
                                              ...
                                              "should"
                                              "supertest")))))))
    (inputs (list node-type-is ;-1.6.18
 node-raw-body ;-2.5.2
 node-qs ;-6.12.0
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("cat-stream" "istanbul" "mocha"
                                              "sinon")))))))
    (inputs (list node-readable-stream ;-2.3.8
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("istanbul" "mocha" "koa"
                                              "supertest")))))))
    (inputs (list node-streaming-json-stringify ;-3.1.0
 node-koa-is-json ;-1.0.0
))
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("babel-cli" "babel-eslint"
                                              ...
                                              "tempfile"
                                              "webpack")))))))
    (inputs (list node-steno ;-0.4.4
 node-pify ;-3.0.0
 node-lodash ;-4.17.21

                  node-is-promise ;-2.2.2
     ...
     (list
      ...
      #:phases #~(modify-phases %standard-phases
                   ...
                   (add-after 'patch-dependencies 'delete-dev-dependencies
                     (lambda _
                       (delete-dependencies '("tape")))))))
    (inputs (list node-typedarray ;-0.0.6
 node-readable-stream ;-2.3.8
...
(define-public node-whatwg-url
  (package
    ...
    (inputs (list node-webidl-conversions ;-3.0.1
 node-tr46 ;-0.0.3
))
    (home-page "https://github.com/jsdom/whatwg-url#readme")
    (synopsis
...
;; DEBUG Changed the package name (was 'node-tldts' ; -core') to avoid depedencies cycle issue.
(define-public node-tldts-core
  (package
   ;; DEBUG : added the 'core' after 'node-tldts' (was before : 'node-tldts ; -core') because it avoid dependencies cycle issue.
			       ...
			       (add-after 'patch-dependencies 'delete-dev-dependencies
					  (lambda _
					    (delete-dependencies '("@rollup/plugin-node-resolve"
								   ...
								   "tldts-tests"
								   "typescript")))))))
   ;; DEBUG I had to add the 'core' after the package name because it calls another version of the 'node-tldts' so that way it avoids issue with 'dependencies cycle.
...
(define-public node-bitwarden-cli
  (package
    ...
    (inputs (list node-zxcvbn ;-4.4.2
		  ...
		  ;; DEBUG I had to modidy manually the package version because the last '-' was before 'lts' which is part of the package version but '-1.4.5' was not detected by my script due to this.
		  ...
		  ;; DEBUG I had to add the final 'r' in 'routeR' because it was not there from the recursive import.
                  node-koa-router ;-12.0.1
